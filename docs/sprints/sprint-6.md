...
| S6-06 | Scaffold the Next.js app in `frontend/` | Matches `repository-structure.md`'s reserved `frontend/` folder; ESLint/Prettier configured; a frontend CI workflow (lint + build) added per `branching.md`'s PR checklist. |
